...
# Let CTest resolve the executable locations generated by CMake. This avoids
# making assumptions about single- versus multi-config generators or Windows
...
if(NOT ILIC_BUILD_CONFIG STREQUAL "")
    list(APPEND test_command -C "${ILIC_BUILD_CONFIG}")
endif()
execute_process(
...
if(NOT test_result EQUAL 0)
    message(FATAL_ERROR
        "Installed-package consumers failed:\n${test_output}\n${test_error}")
endif()
